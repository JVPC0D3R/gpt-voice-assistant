...
class GPTAssistant():
    ...
    def __init__(self, startListening=False, startTexting = False, voice=False, local=False):
        ...
        self.cdet = CommandDetector(model_path = "./models/cd_CKPT_V")
        ...
        while True:
            ...
            if (command != 'goodbye'):
                    ...
                    if command == "google":
                        ...
                        if (self.voice):
                            self.play_audio(response = self.google.notification, exit = exit, response_name = "google_notification.mp3")
